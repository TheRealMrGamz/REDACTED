...
namespace PSXShaderKit
{
    public class PSXPostProcessEffect : MonoBehaviour
    {
        ...
        private float _PixelationFactor = 0.8f;
        ...
        private ColorEmulationMode _ColorEmulationMode = ColorEmulationMode.Fullscreen_Accurate;
        [SerializeField]
        ...
        private float _DitheringScale = 0.3f;
        ...
        void Start()
        {
            ...
            {
                _InterlacingSize = -1;
                Debug.LogWarning("Interlacing shader not supported or not assigned. Interlacing effect will be disabled.");
            }
            UpdateValues();
        }
        ...
        void ApplyInterlacingEffect(RenderTexture source, RenderTexture destination)
        {
            ...
            {
                Debug.LogError($"Error in ApplyInterlacingEffect: {e.Message}");
                Graphics.Blit(source, destination);
            }
        }
